...
# -----------------------
# 7. Hybrid Chat System (Final Perfected Version)
# -----------------------
st.divider()
...
if user_input:
    ...
    with st.chat_message("assistant"):
        ...
        sys_msg = (
            ...
            f"If the user wants a photo/image, start with 'GENERATE_IMAGE: [Detailed English Prompt]' "
            f"then continue in Sinhala. Today: {datetime.date.today()}. User: {user_info['full_name']}."
        )

        # 🛠️ Fix: Clean messages to prevent Groq API errors
            ...
            if "GENERATE_IMAGE:" in full_res:
                ...
                with st.spinner("Alpha is generating your photo..."):
                    try:
                        ...
                        # Generating the high-quality image URL
